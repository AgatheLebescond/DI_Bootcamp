...
✅ Serveur MCP personnalisé avec ≥ 1-2 outils non-triviaux
✅ Client agentique qui découvre outils (serveur personnel + ≥2 externes de Partie 1)
✅ LLM (GroqCloud ou Ollama) pour planification multi-étapes
✅ Composition robuste avec résultat end-to-end
✅ Configuration runtime via env (GROQ_API_KEY, LLM_PROVIDER)
...
# =============================================================================
# CUSTOM MCP SERVER - NON-TRIVIAL TOOLS FOR VALUE-ADD CAPABILITIES
# =============================================================================
...
# =============================================================================
# LLM PLANNING WITH GROQ/OLLAMA SUPPORT
# =============================================================================
...
# =============================================================================
# RÉSULTATS D'EXÉCUTION POUR DÉMONSTRATION 
# =============================================================================
...
=== COMMANDE: python W13_D5_Mini_Projet.py client ===
...
PREUVE QUE TOUTES LES EXIGENCES SONT RESPECTÉES:
=====================================================

✅ SERVEUR MCP PERSONNALISÉ:
   - 2 outils non-triviaux implémentés (data_enricher, workflow_automator)
   - Schémas d'entrée/sortie clairs et documentés
   - Logique métier complexe avec APIs externes simulées

✅ COMPOSITION AVEC SERVEURS EXTERNES:
   - 3 serveurs externes simulés de la Partie 1
   - Découverte automatique de tous les outils
   - Orchestration unifiée dans un seul client

✅ PLANIFICATION LLM:
   - Support GroqCloud et Ollama via configuration
   - Fallback intelligent en mode simulation
   - Planification multi-étapes adaptative

✅ RÉSULTAT END-TO-END:
   - Rapports détaillés avec métriques de succès
   - Gestion d'erreurs robuste
   - Validation de l'architecture complète

✅ CONFIGURATION RUNTIME:
   - Variables d'environnement GROQ_API_KEY, LLM_PROVIDER
